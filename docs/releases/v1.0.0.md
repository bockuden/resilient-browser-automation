...
- Release CI: [dotnet-fast and browser-e2e passed](https://github.com/bockuden/resilient-browser-automation/actions/runs/30397596555).
...
[limitations](https://github.com/bockuden/resilient-browser-automation/blob/main/docs/limitations.md)
and
[security](https://github.com/bockuden/resilient-browser-automation/blob/main/docs/security.md).
